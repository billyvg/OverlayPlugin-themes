			...
			controller:['$scope', '$document', 
				function($scope, $document) {
					...
					$scope.colsCollection = [
						...
						{label:  'Crit Hits',value: 'crithits'},{label:  'Crit Hits (%)',value: 'crithitPct'},{label:  'Direct Hit (%)',value: 'DirectHitPct'},
						{label:  'Hit Failed',value: 'hitfailed'},{label:  'Swings',value: 'swings'},{label:  'DHC',value: 'CritDirectHitCount'},
						{label:  'DHC (%)',value: 'CritDirectHitPct'},{label:  'Best Attack',value: 'maxhit'},{label:  'Best Damage',value: 'MAXHIT'},
						...
						{label:  'Name (15)',value: 'NAME15'},{label:  'Name (16)',value: 'NAME16'},{label:  'Last 30s DPS',value: 'Last30DPS'},
